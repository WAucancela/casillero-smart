...
def upgrade() -> None:
    ...
    op.create_table('administradores',
        ...
        sa.Column('rol', postgresql.ENUM('superadmin', 'admin', 'viewer', name='rol_admin', create_type=False), nullable=False, server_default='admin'),
    ...
    op.create_table('usuarios',
        ...
        sa.Column('estado', postgresql.ENUM('pendiente_biometria', 'activo', 'inactivo', name='estado_usuario', create_type=False), nullable=False, server_default='pendiente_biometria'),
        sa.Column('fecha_creacion', sa.DateTime, nullable=False, server_default=sa.text('NOW()')),
        sa.Column('fecha_actualizacion', sa.DateTime),
    ...
    op.create_table('casilleros',
        ...
        sa.Column('estado', postgresql.ENUM('libre', 'ocupado', 'bloqueado', 'mantenimiento', name='estado_casillero', create_type=False), nullable=False, server_default='libre'),
    ...
    op.create_table('accesos_log',
        ...
        sa.Column('resultado', postgresql.ENUM(
            'exitoso', 'denegado_biometria', 'denegado_usuario_inactivo',
            'denegado_sin_casillero', 'denegado_fuera_horario', 'error_hardware',
            name='resultado_acceso', create_type=False), nullable=False),
